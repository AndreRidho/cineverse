...
class _MovieRemoteDataSource implements MovieRemoteDataSource {
  ...
  @override
  Future<dynamic> createRequestToken({required String apiKey}) async {
  ...
  @override
  Future<dynamic> validateWithLogin({
  ...
  Future<dynamic> createSession({
    required String apiKey,
    required Map<String, dynamic> requestToken,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(requestToken);
    final _options = _setStreamType<dynamic>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  Future<dynamic> deleteSession({
    required String apiKey,
    required Map<String, dynamic> sessionId,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<dynamic> getAccountDetails({required String sessionId}) async {
    final _extra = <String, dynamic>{};
