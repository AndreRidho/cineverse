class Languages {
  final isoLangs = {
    ...
    "av": {"name": "Avaric", "nativeName": "авар"},
    "ae": {"name": "Avestan", "nativeName": "avesta"},
    "ay": {"name": "Aymara", "nativeName": "aymar"},
    ...
    "cv": {"name": "Chuvash", "nativeName": "чӑваш"},
    ...
    "fj": {"name": "Fijian", "nativeName": "vosa"},
    ...
    "jv": {"name": "Javanese", "nativeName": "basa"},
    ...
    "ky": {"name": "Kirghiz, Kyrgyz", "nativeName": "кыргыз"},
    "kv": {"name": "Komi", "nativeName": "коми"},
    ...
    "ms": {"name": "Malay", "nativeName": "bahasa"},
    "ml": {"name": "Malayalam", "nativeName": "മലയാളം"},
    "mt": {"name": "Maltese", "nativeName": "Malti"},
    "mi": {"name": "Māori", "nativeName": "te"},
    "mr": {"name": "Marathi (Marāṭhī)", "nativeName": "मराठी"},
    "mh": {"name": "Marshallese", "nativeName": "Kajin"},
    "mn": {"name": "Mongolian", "nativeName": "монгол"},
    "na": {"name": "Nauru", "nativeName": "Ekakairũ"},
    "nv": {"name": "Navajo, Navaho", "nativeName": "Diné"},
    "nb": {"name": "Norwegian Bokmål", "nativeName": "Norsk"},
    ...
    "om": {"name": "Oromo", "nativeName": "Afaan"},
    "or": {"name": "Oriya", "nativeName": "ଓଡ଼ିଆ"},
    "os": {"name": "Ossetian, Ossetic", "nativeName": "ирон"},
    "pa": {"name": "Panjabi, Punjabi", "nativeName": "ਪੰਜਾਬੀ"},
    "pi": {"name": "Pāli", "nativeName": "पाऴि"},
    "fa": {"name": "Persian", "nativeName": "فارسی"},
    "pl": {"name": "Polish", "nativeName": "polski"},
    "ps": {"name": "Pashto, Pushto", "nativeName": "پښتو"},
    "pt": {"name": "Portuguese", "nativeName": "Português"},
    "qu": {"name": "Quechua", "nativeName": "Runa"},
    ...
    "sm": {"name": "Samoan", "nativeName": "gagana"},
    "sg": {"name": "Sango", "nativeName": "yângâ"},
    ...
    "su": {"name": "Sundanese", "nativeName": "Basa"},
    ...
    "tl": {"name": "Tagalog", "nativeName": "Wikang"},
    "tn": {"name": "Tswana", "nativeName": "Setswana"},
    "to": {"name": "Tonga (Tonga Islands)", "nativeName": "faka"},
    "tr": {"name": "Turkish", "nativeName": "Türkçe"},
    "ts": {"name": "Tsonga", "nativeName": "Xitsonga"},
    "tt": {"name": "Tatar", "nativeName": "татарча"},
    "tw": {"name": "Twi", "nativeName": "Twi"},
    "ty": {"name": "Tahitian", "nativeName": "Reo"},
    "ug": {"name": "Uighur, Uyghur", "nativeName": "Uyƣurqə"},
    ...
    "za": {"name": "Zhuang, Chuang", "nativeName": "Saɯ"}
  };

  String getDisplayLanguage(key, {String? backup}) {
